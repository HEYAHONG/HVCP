...
HRESULT CRingBuffer::Initialize(__in SIZE_T BufferSize)
{
    HRESULT hr = S_OK;
    PBYTE buffer = NULL;
...
HRESULT CRingBuffer::Write(__in_bcount(DataSize) PBYTE Data,__in SIZE_T DataSize)
{
...
HRESULT CRingBuffer::Read(__out_bcount(DataSize) PBYTE Data,__in SIZE_T DataSize,__out SIZE_T *BytesCopied)
{
